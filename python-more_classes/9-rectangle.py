...
class Rectangle:
    ...
    def square(cls, size=0):
        ...
        This method is a class method, meaning it's bound to the class and
        not the instance of the object.
        It's used to create a square, which is a special case of a
        rectangle where the width and height are equal.
        """
